        ...
        <div class="sb2-2">
            ...
            <div class="sb2-2-add-blog sb2-2-1">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        <h4>Add Image</h4>
                        <p> Adding Images to... <strong>{{$Product->title}}</strong> </p>
                        <center>
                    ...
                    <div class="bor">
                        <form method="POST" action="{{url('/')}}/admin/add_image/{{$Product->id}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="row">
                                <div class="input-field col s12">
                                    <input value="{{$Product->title}}" autocomplete="off" name="title" id="list-title" type="text" class="validate" required readonly>
                               ...
                               <div class="">
                                    ...
                                    <div class="input-field col s4">
                                        <div class="form-group">
                                            ...
                                            <img class="image-preview" style="width:auto;" src="{{$Product->image_two}}" id='img-upload'/>
                                        </div>
                                    </div>
                                    <div class="input-field col s4">
                                        <div class="form-group">
                                            ...
                                            <img class="image-preview" style="width:auto;" src="{{$Product->image_three}}" id='img-upload'/>
                                        </div>
                                    </div>

                                    <div class="input-field col s4">
                                        <div class="form-group">
                                            <label>Four Image</label>
                                            <div class="input-group">
                                                <span class="input-group-btn">
                                                    <span class="btn btn-default btn-file">
                                            ...
                                            <img class="image-preview" style="width:auto;" src="{{$Product->image_four}}" id='img-upload'/>
                                        </div>
                                    </div>
                                </div>
                            </div>
