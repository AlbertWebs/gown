            ...
            <div class="return-policy">
                ...
                <div class="hired-gown-policy">
                    ...
                    <p>
                        ...
                        If the gown is not returned within <strong>[X days]</strong>, it will be considered lost, and the full gown value will be charged.
                    </p>
                ...
                <div class="purchased-gown-policy">
                    ...
                    <ul>
                        ...
                        <li>Returns must be made within <strong>[X days]</strong> from the date of purchase.</li>
                    </ul>
                    ...
                    <p>Approved returns will be eligible for a <strong>refund or exchange</strong>. Refunds will be processed via the original payment method within <strong>[X days]</strong>.</p>

                    <h4>2.4 Defective or Incorrect Items</h4>
                    <p>If you receive a <strong>damaged</strong> or <strong>incorrect</strong> gown, please notify us within <strong>[X days]</strong>, and we will arrange for a replacement or refund at no extra cost.</p>
                </div>
