             ...
             <div class="container  d-flex align-items-center pt-100 pb-100 pt-sm-120 pb-sm-120 " style="min-height: 80vh">
                 ...
                 <div class="home-content">
                     <div class="row">
                         ...
                         <?php
                            $Cats = \App\Models\Category::find(3);
                        ?>
                         <!-- End Home Section Text -->
                         <div class="local-scroll pt-20">
                            <a href="{{route('shop-attire',$Cats->slung)}}" class="btn btn-mod btn-w btn-large circle btn-border-m"><span>Shop Now Church Wear</span></a>
                         </div>
        ...
        <div class="container position-relative perfection">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6 col-xl-6" style="margin: 0 auto">
                    ...
                    <a href="{{route('shop-attire',$Cats->slung)}}" class="btn btn-mod btn-color btn-large btn-round btn-hover-anim btn-border-m">
                ...
                <div class="col-md-6 col-lg-3 mt-50 mt-sm-40">
                    <a href="#" class="portfolio-5-link">
                        ...
                        <div class="portfolio-4-image prod-img">
                            ...
                            <div class="wow fadeIn prod-img" data-wow-delay="1s">
