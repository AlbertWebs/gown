...
<html lang="en">
    <head>
        ...
        {{--  --}}
        <title>Shop {{$SubCategory->title}} in Kenya |  {{$Category->title}} | Gownsea LTD</title>
        ...
        <meta name="keywords" content="{{$SubCategory->title}} Kenya, buy graduation gown, rent graduation gown, custom {{$Category->title}}, PhD gowns, master's gowns, degree gowns, diploma gowns, preschool gowns">
        <meta name="author" content="Gownsea LTD">
        <meta name="robots" content="index, follow">
        <link rel="canonical" href="{{url('/')}}/shop-attire-collection/{{$Category->slung}}/{{$SubCategory->slung}}" />

        <!-- Open Graph (Facebook, LinkedIn, etc.) -->
        <meta property="og:title" content="Shop {{$SubCategory->title}} in Kenya |  {{$Category->title}} | Gownsea LTD">
        ...
        <meta property="og:url" content="{{url('/')}}/shop-attire-collection/{{$Category->slung}}/{{$SubCategory->slung}}">
        ...
        <meta name="twitter:title" content="Shop {{$SubCategory->title}} in Kenya |  {{$Category->title}} | Gownsea LTD">
        <meta name="twitter:description" content="We offer premium {{$SubCategory->title}} for sale and hire, with custom stitching options. Find the perfect gown for your special day!">
