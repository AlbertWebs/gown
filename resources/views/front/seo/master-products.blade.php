...
<html lang="en">
    <head>
        ...
        {{--  --}}
        <title>Shop {{$Category->title}} in Kenya | Gownsea LTD</title>
        ...
        <link rel="canonical" href="{{url('/')}}/shop-attire/{{$Category->slung}}" />

        <!-- Open Graph (Facebook, LinkedIn, etc.) -->
        <meta property="og:title" content="Shop {{$Category->title}} in Kenya | Gownsea LTD">
        ...
        <meta property="og:url" content="{{url('/')}}/shop-attire/{{$Category->slung}}">
        ...
        <meta name="twitter:title" content="Shop {{$Category->title}} in Kenya | Gownsea LTD">
