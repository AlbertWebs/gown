...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="{{$Blog->title}} -Graduation Gowns for Hire - Gownsea LTD ">
        <meta property="og:description" content="{{$Blog->meta}}">
        <meta property="og:image" content="{{url('/')}}/theme/images/logs_g.webp">
        <meta property="og:url" content="{{url('/')}}/blog/{{$Blog->slung}}">
        ...
        <meta name="twitter:title" content="{{$Blog->title}} -Graduation Gowns for Hire - Gownsea LTD ">
