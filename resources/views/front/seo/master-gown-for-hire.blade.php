...
<html lang="en">
    <head>
        ...
        {{--  --}}
        <title>{{$Gown->title}} For Hire | For Sale in Kenya | Gownsea LTD</title>
        ...
        <meta name="keywords" content="{{$Gown->title}} Kenya, buy graduation gown, rent graduation gown, custom {{$Gown->title}}, PhD gowns, master's gowns, degree gowns, diploma gowns, preschool gowns">
        <meta name="author" content="Gownsea LTD">
        <meta name="robots" content="index, follow">
        <link rel="canonical" href="{{url('/')}}/gown-for-hire/{{$slung}}" />

        <!-- Open Graph (Facebook, LinkedIn, etc.) -->
        <meta property="og:title" content="{{$Gown->title}} For Hire | For Sale in Kenya | Gownsea LTD">
        ...
        <meta property="og:url" content="{{url('/')}}/gown-for-hire/{{$slung}}">
        ...
        <meta name="twitter:title" content="{{$Gown->title}} For Hire | For Sale in Kenya | Gownsea LTD">
        ...
        <script type="application/ld+json">
        {
          ...
          "description": "We offer high-quality {{$Gown->title}} for sale and hire, covering preschool to PhD levels, plus custom stitching services for unique designs.",
